  ...
  return (
    <div className="">
      ...
      <section className="relative mb-28">
        <span className="absolute w-5/12 h-screen right-0 bottom-0 ">
          <DecorIntersect className="fill-accent-4" />
        </span>
        <div className="w-96 h-96 bg-accent-3 rounded-full blur-3xl absolute -left-80 -top-10"></div>
          ...
          <div className="flex ">
            <div className="w-6/12 pt-32">
              ...
              <div className="flex">
                <div>
                  <Link href="/">
                    <a className="mr-11 bg-accent-1 shadow-accent-1/10 shadow-[0_20px_35px] px-6 py-5 text-white rounded-xl">
                      Find Out More
                    </a>
                  </Link>
                  <button className="flex-right item-center ">
                    <span
                      className="mr-6 bg-accent-2 text-white inline-flex item-center justify-center px-5 py-5 rounded-full shadow-accent-2/30 
                  shadow-[0_15px_30px]"
                    >
                      <span className="material-icons 50px">play_arrow</span>
                    </span>
      ...
      <section className="mb-32">
        <div className="max-w-7xl mx-auto relative px-4">
          ...
          <div className="text-center flex flex-col mb-16">
            <h3 className="upercase text-lg mb-2 text-gray-500">catergory</h3>
          ...
          <div className="flex text-gray-900">
            <div className="w-3/12 px-8">
              <div className="relative transition-all duration-300 group shadow-none hover:shadow-great flex flex-col items-center justify-center text-center bg-white rounded-[36px]">
                <div
                  className="absolute transition-all duration-300 opacity-0 group-hover:opacity-100 -z-10 bottom-12  
                group-hover:bottom-6 left-12 group-hover:left-6 transform -translate-x-1/2 translate-y-1/2 bg-accent-2 
                rounded-tl-3xl rounded-br-lg w-28 h-28"
                ></div>
                <div className="relative mb-6 inline-flex h-28 ">
                  ...
                  <div
                    className="absolute bottom-0 left-5 transform -translate-x-1/2 bg-accent-4 rounded-tl-lg rounded-tr-md 
                 rounded-bl-md rounded-br-2xl w-12 h-12"
                  ></div>
                </div>
            ...
            <div className="w-3/12 px-8">
              <div className="relative transition-all duration-300 group shadow-none hover:shadow-great flex flex-col items-center justify-center text-center bg-white rounded-[36px]">
                ...
                <div className="relative mb-6 inline-flex h-28 ">
                  ...
                  <div
                    className="absolute bottom-8  -right-5 transform -translate-x-1/2 bg-accent-4 rounded-tl-md rounded-tr-md 
                 rounded-bl-2xl rounded-br-lg w-12 h-12"
                  ></div>
                </div>
            ...
            <div className="w-3/12 px-8">
              <div className="relative transition-all duration-300 group shadow-none hover:shadow-great flex flex-col items-center justify-center text-center bg-white rounded-[36px]">
                ...
                <div className="relative mb-6 inline-flex h-28 ">
                  ...
                  <div
                    className="absolute top-10  left-3 transform -translate-x-1/2 bg-accent-4 rounded-tl-md rounded-tr-2xl 
                 rounded-bl-lg rounded-br-md w-12 h-12"
                  ></div>
                </div>
            ...
            <div className="w-3/12 px-8">
              <div className="relative transition-all duration-300 group shadow-none hover:shadow-great flex flex-col items-center justify-center text-center bg-white rounded-[36px]">
                ...
                <div className="relative mb-6 inline-flex h-28 ">
                  ...
                  <div
                    className="absolute bottom-0 left-5 transform -translate-x-1/2 bg-accent-4 rounded-tl-md rounded-tr-lg 
                 rounded-bl-2xl rounded-br-md w-12 h-12"
                  ></div>
                </div>
      ...
      <section className="mb-28 ">
        <div className="text-center flex flex-col mb-16">
          <div className="max-w-7xl mx-auto relative px-4">
            <h3 className="upercase text-lg mb-2 text-gray-500">Top Selling</h3>
            <h3 className="font-serif text-5xl text-gray-900 leading-snug">
              Top Destinations
            </h3>
          </div>
          <div className="flex relative pr-10">
            <div className="absolute w-[96px] h-252 bottom-10 right-0">
              ...
              <div className="rounded-3xl pb-10 shadow-great bg-white flex flex-col">
                ...
                <div className="rounded-tr-3xl rounded-tl-3xl text-gray-500">
                  ...
                  <div className="pt-4 px-5 flex items-center">
                    <span className="material-icons 50px">near_me</span>
                    <span className="">10 Days Trips</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-4/12 px-6 relative z-20">
              <div className="rounded-3xl pb-10 shadow-great bg-white flex flex-col">
                ...
                <div className="rounded-tr-3xl rounded-tl-3xl text-gray-500">
                  ...
                  <div className="pt-4 px-5 flex items-center">
                    <span className="material-icons 50px">near_me</span>
                    <span className="">12 Days Trips</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-4/12 px-6 relative z-20">
              <div className="rounded-3xl pb-10 shadow-great bg-white flex flex-col">
                ...
                <div className="rounded-tr-3xl rounded-tl-3xl text-gray-500">
                  ...
                  <div className="pt-4 px-5 flex items-center">
                    <span className="material-icons 50px">near_me</span>
                    <span className="">28 Days Trips</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-5/12 flex items-center justify-center">
              <div className="w-[370px] relative ">
                ...
                <div className="bg-white rounded-2xl w-full h-full relative z-20 shadow-great pt-4 pb-5">
                  ...
                  <h6 className="font-bolt text-lg text-gray-500 px-4 mb-2">
                    Rome, Italy
                  </h6>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex">
            <div className="w-1/5 px-4">
              <div
                className="h-20 px-4 py-4 relative grayscale hover:grayscale-0 bg-white transform hover:-translate-1 
              hover:shadow-great rounded-2xl transition-all duration-300"
              >
                <Image
        ...
        <div className="max-w-7xl mx-auto relative px-4">
          ...
          <div className="w-full relative bg-white">
            <div className="relative ">
              <div
                className="absolute flex justify-center items-center text-white rounded-full transform -translate-y-1/2 
              translate-x-1/2 z-30 top-0 right-0 w-16 h-16 bg-gradient-to-b from-accent-6/60 to-accent-6"
              >
                <span className="material-icons">near_me</span>
              </div>
            </div>
            <div className="bg-accent-3/20 rounded-tl-[129px] rounded-3xl relative z-20 pt-20 pb-20 mb-8 ">
              <div className="w-[224px] h-[320px] absolute z-0 -top-16 -right-28 transform -rotate-90">
                <DecorEllips1 className="stroke-accent-6 opacity-10" />
              </div>
              <div className="w-[390px] h-[390px] absolute z-0 -bottom-24 left-4 transform ">
                <DecorEllips1 className="stroke-accent-6 opacity-10" />
              </div>
                ...
                <form className="flex justify-center ">
                  <fieldset className="relative mr-8">
                    ...
                    <input
                      ...
                      className="apperance-none rounded-lg py-4 pl-14 bg-white w-96 focus:outline-none transsition duration-300 
                        border-20 border-transparent focus:border-accent-6 "
                    />
                  </fieldset>
          ...
          <div className="flex mb-12">
            ...
            <div className="w-2/12 px-4 ">
              <ul className="text-lg text-gray-500 flex gap-x-5">
                <li>
                  <a
                    href="https://github.com/Ferdyarya/Travel-NextJS.git"
                    className="w-10 h-10 bg-white group overflow-hidden relative shadow-lg flex items-center justify-center rounded-full"
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <span
                      className="group-hover:opacity-100 opacity-0 z-10 transform rotate-0 
                    group-hover:rotate-180 transition-all duration-300 bg-gradient-social absolute inset-0"
                    ></span>
              ...
              <ul className="flex gap-x-4 mb-12">
